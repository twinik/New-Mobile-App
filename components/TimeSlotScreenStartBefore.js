...
const TimeSlotScreenStartBefore = () => {
    ...
    let slots = stateNewtask[0].slotsSB
    let fisrtsSlot = stateNewtask[0].job_inicio_plan_time
    ...
    const [datexSB, setdatexSB] = React.useState(moment(stateNewtask[0].job_inicio_plan_date));
        ...
        const renderItem = ({ item }) => {
            return (
                <TouchableOpacity onPress={() => {
                    ...
                    setbookSB(true)
                    setUpdateNewTaskField({"key":"job_inicio_plan_time", "value": `${item}`})
                }}>
                    <View style={{
    ...
    function defaultslots(selectedDate){
        ...
        if (selectedDate.format('YYYY-MM-DD') != today.format("YYYY-MM-DD")){
            ...
            //let slots = calcSlots(today,true)
    ...
    function onDateSelected (selectedDate) {
        ...
        setUpdateNewTaskField({"key":"job_inicio_plan_date", "value": selectedDate.format()})
...
TimeSlotScreenStartBefore.navigationOptions = {
    title: 'Edit Start date selection',
...
export default TimeSlotScreenStartBefore;