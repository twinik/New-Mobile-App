            ...
            <View style={styles.orderDetailWrapStyle}>
                <View style={styles.orderAndPaymentDetailWrapStyle}>
                    <View style={{ flexDirection: 'row' }}>
                        <MaterialIcons name="add-task" size={24} color={Colors.primaryColor} />
                    ...
                    <View>
                        ...
                        <View style={{ marginTop: Sizes.fixPadding -4, marginBottom: Sizes.fixPadding - 9.0 }}>
                            <Text style={{ ...Fonts.blackColor14Medium }}>
                                {`@ ${item.orderStatus}`}
                            </Text>
                            <View style={{ marginTop: Sizes.fixPadding -4 }}>
                ...
                <View style={styles.deliveryAndPickupAddressWrapStyle}>
                    ...
                    <Text style={{
                        ...Fonts.blackColor16Medium, marginLeft: 5, marginRight:5
